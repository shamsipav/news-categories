...
<Modal bind:this={ modal } hasFooter={ false } title="Редактирование категории">
    <Form method="PUT" action="https://localhost:7220/api/Category/{category.id}" content="application/json" reset={ false } on:success={ handleSuccess }>
        <div class="mb-3">
...
<Modal bind:this={ modalDelete } hasFooter={ false } title="Удаление категории">
    <Form method="DELETE" action="https://localhost:7220/api/Category/{category.id}" content="application/json" redirect="/categories">
